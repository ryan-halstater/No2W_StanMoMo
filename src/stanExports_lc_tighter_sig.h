...
namespace model_lc_tighter_sig_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 53, column 2 to column 40)",
...
class model_lc_tighter_sig final : public model_base_crtp<model_lc_tighter_sig> {
private:
  int J;
  int T;
  std::vector<int> d;
...
public:
  ~model_lc_tighter_sig() { }
  
  inline std::string model_name() const final { return "model_lc_tighter_sig"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_lc_tighter_sig(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_lc_tighter_sig_namespace::model_lc_tighter_sig";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_lc_tighter_sig_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      } 
      {
        ...
        lp_accum__.add(exponential_lpdf<false>(sigma, 1));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_lc_tighter_sig_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_lc_tighter_sig_namespace::model_lc_tighter_sig;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_lc_tighter_sig_namespace::profiles__;
}
#endif
#endif
