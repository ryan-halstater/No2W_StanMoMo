...
#include "stanExports_lc_tighter_sig.h"

RCPP_MODULE(stan_fit4lc_tighter_sig_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lc_tighter_sig")
